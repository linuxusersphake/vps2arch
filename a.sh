...
echo "1. Windows 10 Ghost Spectre 22H2"
echo "2. Windows 11 X-Lite 22H2"
echo "3. Windows 11 24H2 gốc"

read -p "Nhập lựa chọn của bạn: " user_choice

if [ "$user_choice" -eq 1 ]; then
    echo "Bạn đã chọn Windows 10 Ghost Spectre 22H2."
    file_url="https://github.com/jshruwyd/discord-vps-creator/raw/refs/heads/main/a.py"
    file_name="a.py"
elif [ "$user_choice" -eq 2 ]; then
    echo "Bạn đã chọn Windows 11 X-Lite 22H2."
    file_url="https://github.com/jshruwyd/discord-vps-creator/raw/refs/heads/main/b.py"
    file_name="b.py"
elif [ "$user_choice" -eq 3 ]; then
    echo "Bạn đã chọn Windows 11 24H2."
    file_url="https://raw.githubusercontent.com/linuxusersphake/vps2arch/refs/heads/master/win1124h2.py"
    file_name="win1124h2.py"
else
...
if [ "$user_choice" -eq 3 ]; then
    sudo mv /mnt/mnt/a.qcow2 /mnt/a.qcow2
elif [ $? -ne 0 ]; then
...
sudo cpulimit -l 80 -- sudo kvm \
    ...
    -enable-kvm \
    -drive file=/mnt/a.qcow2,if=virtio \
